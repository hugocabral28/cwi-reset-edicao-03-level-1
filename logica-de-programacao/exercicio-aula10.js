let colaboradores = [
  'Rhoger', 'Cléverson', 'Gleysberto', 'Nádio',
 'Rosiméri', 'Regislane', 'Agripino', 'Wellison'
];
...
function verificarAposentadoria(nome){
  ...
  //percorrendo o array e verificando se o colaborador existe
  ...
  //Verificando se o colaborador existe e se tem pelo menos uma das 3 regras
  if(colaborador){
